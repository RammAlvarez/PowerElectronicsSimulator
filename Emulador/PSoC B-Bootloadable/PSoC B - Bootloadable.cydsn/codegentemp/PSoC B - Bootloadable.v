// ======================================================================
// PSoC B - Bootloadable.v generated from TopDesign.cysch
// 07/14/2015 at 01:31
...
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\3.2\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\Bus_Connect_v2_10"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\3.2\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\Bus_Connect_v2_10\Bus_Connect_v2_10.v"
`endif
...
module ADC_SAR_SEQ_P4_v2_10_1 (
	...
	cy_clock_v1_0
		#(.id("c9579c28-f9d7-48af-814c-87df7e2f4e0e/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
...
// CharLCD_v2_10(ConversionRoutines=true, CUSTOM0=0,E,8,8,8,E,0, CUSTOM1=0,A,A,4,4,4,0, CUSTOM2=0,E,A,E,8,8,0, CUSTOM3=0,E,A,C,A,A,0, CUSTOM4=0,E,8,C,8,E,0, CUSTOM5=0,E,8,E,2,E,0, CUSTOM6=0,E,8,E,2,E,0, CUSTOM7=0,4,4,4,0,4,0, CustomCharacterSet=0, TypeReplacementString=uint32, CY_COMPONENT_NAME=CharLCD_v2_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LCD, CY_INSTANCE_SHORT_NAME=LCD, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2, INSTANCE_NAME=LCD, )
module CharLCD_v2_10_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("e5e73de7-b769-46c3-a680-717320eb3e0f/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    ADC_SAR_SEQ_P4_v2_10_1 ADC_SAR (
        .Vref(Net_146),
        .sdone(Net_147),
        .eoc(Net_148),
        .aclk(1'b0),
	...
	wire [0:0] tmpOE__Analog_Input_Pin_2_net;
	wire [0:0] tmpFB_0__Analog_Input_Pin_2_net;
	wire [0:0] tmpIO_0__Analog_Input_Pin_2_net;
	wire [0:0] tmpINTERRUPT_0__Analog_Input_Pin_2_net;
	electrical [0:0] tmpSIOVREF__Analog_Input_Pin_2_net;

	cy_psoc3_pins_v1_10
		#(.id("6159f099-3d8c-45ee-8040-a6f2754b1088"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Analog_Input_Pin_2
		 (.oe(tmpOE__Analog_Input_Pin_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Analog_Input_Pin_2_net[0:0]}),
		  .analog({Net_195}),
		  .io({tmpIO_0__Analog_Input_Pin_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Analog_Input_Pin_2_net),
		  .interrupt({tmpINTERRUPT_0__Analog_Input_Pin_2_net[0:0]}),
		  .annotation({Net_190}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Analog_Input_Pin_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Analog_Input_Pin_3_net;
	wire [0:0] tmpFB_0__Analog_Input_Pin_3_net;
	wire [0:0] tmpIO_0__Analog_Input_Pin_3_net;
	wire [0:0] tmpINTERRUPT_0__Analog_Input_Pin_3_net;
	electrical [0:0] tmpSIOVREF__Analog_Input_Pin_3_net;

	cy_psoc3_pins_v1_10
		#(.id("adbeb537-32f9-45e4-9745-2230112ed0f7"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Analog_Input_Pin_3
		 (.oe(tmpOE__Analog_Input_Pin_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Analog_Input_Pin_3_net[0:0]}),
		  .analog({Net_196}),
		  .io({tmpIO_0__Analog_Input_Pin_3_net[0:0]}),
		  .siovref(tmpSIOVREF__Analog_Input_Pin_3_net),
		  .interrupt({tmpINTERRUPT_0__Analog_Input_Pin_3_net[0:0]}),
		  .annotation({Net_192}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Analog_Input_Pin_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Analog_Input_Pin_1_net;
	wire [0:0] tmpFB_0__Analog_Input_Pin_1_net;
	wire [0:0] tmpIO_0__Analog_Input_Pin_1_net;
	wire [0:0] tmpINTERRUPT_0__Analog_Input_Pin_1_net;
	electrical [0:0] tmpSIOVREF__Analog_Input_Pin_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Analog_Input_Pin_1
		 (.oe(tmpOE__Analog_Input_Pin_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Analog_Input_Pin_1_net[0:0]}),
		  .analog({Net_194}),
		  .io({tmpIO_0__Analog_Input_Pin_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Analog_Input_Pin_1_net),
		  .interrupt({tmpINTERRUPT_0__Analog_Input_Pin_1_net[0:0]}),
		  .annotation({Net_105}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Analog_Input_Pin_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Analog_Input_Pin_0_net;
	wire [0:0] tmpFB_0__Analog_Input_Pin_0_net;
	wire [0:0] tmpIO_0__Analog_Input_Pin_0_net;
	wire [0:0] tmpINTERRUPT_0__Analog_Input_Pin_0_net;
	electrical [0:0] tmpSIOVREF__Analog_Input_Pin_0_net;

	cy_psoc3_pins_v1_10
		#(.id("73038d18-90ae-4764-b64c-a4f7ed34bdea"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Analog_Input_Pin_0
		 (.oe(tmpOE__Analog_Input_Pin_0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Analog_Input_Pin_0_net[0:0]}),
		  .analog({Net_270}),
		  .io({tmpIO_0__Analog_Input_Pin_0_net[0:0]}),
		  .siovref(tmpSIOVREF__Analog_Input_Pin_0_net),
		  .interrupt({tmpINTERRUPT_0__Analog_Input_Pin_0_net[0:0]}),
		  .annotation({Net_111}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Analog_Input_Pin_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_isr_v1_0
		#(.int_type(2'b10))
		ISR_UART_RX_FIFO_FULL
		 (.int_signal(Net_21));


	wire [0:0] tmpOE__Digital_Output_Pin_U1_net;
	wire [0:0] tmpFB_0__Digital_Output_Pin_U1_net;
	wire [0:0] tmpIO_0__Digital_Output_Pin_U1_net;
	wire [0:0] tmpINTERRUPT_0__Digital_Output_Pin_U1_net;
	electrical [0:0] tmpSIOVREF__Digital_Output_Pin_U1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		Digital_Output_Pin_U1
		 (.oe(tmpOE__Digital_Output_Pin_U1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Digital_Output_Pin_U1_net[0:0]}),
		  .io({tmpIO_0__Digital_Output_Pin_U1_net[0:0]}),
		  .siovref(tmpSIOVREF__Digital_Output_Pin_U1_net),
		  .interrupt({tmpINTERRUPT_0__Digital_Output_Pin_U1_net[0:0]}),
		  .annotation({Net_135}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Digital_Output_Pin_U1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Digital_Output_Pin_U2_net;
	wire [0:0] tmpFB_0__Digital_Output_Pin_U2_net;
	wire [0:0] tmpIO_0__Digital_Output_Pin_U2_net;
	wire [0:0] tmpINTERRUPT_0__Digital_Output_Pin_U2_net;
	electrical [0:0] tmpSIOVREF__Digital_Output_Pin_U2_net;

	cy_psoc3_pins_v1_10
		#(.id("6879900e-3a20-4807-80b6-0b30e3c69109"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		Digital_Output_Pin_U2
		 (.oe(tmpOE__Digital_Output_Pin_U2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Digital_Output_Pin_U2_net[0:0]}),
		  .io({tmpIO_0__Digital_Output_Pin_U2_net[0:0]}),
		  .siovref(tmpSIOVREF__Digital_Output_Pin_U2_net),
		  .interrupt({tmpINTERRUPT_0__Digital_Output_Pin_U2_net[0:0]}),
		  .annotation({Net_129}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Digital_Output_Pin_U2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SW1_Bootloader_net;
	wire [0:0] tmpFB_0__SW1_Bootloader_net;
	wire [0:0] tmpIO_0__SW1_Bootloader_net;
	wire [0:0] tmpINTERRUPT_0__SW1_Bootloader_net;
	electrical [0:0] tmpSIOVREF__SW1_Bootloader_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		SW1_Bootloader
		 (.oe(tmpOE__SW1_Bootloader_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SW1_Bootloader_net[0:0]}),
		  .io({tmpIO_0__SW1_Bootloader_net[0:0]}),
		  .siovref(tmpSIOVREF__SW1_Bootloader_net),
		  .interrupt({tmpINTERRUPT_0__SW1_Bootloader_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SW1_Bootloader_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
