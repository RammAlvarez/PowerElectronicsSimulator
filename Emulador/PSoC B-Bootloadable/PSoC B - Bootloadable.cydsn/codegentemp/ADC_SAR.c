...
static const uint32 CYCODE ADC_SAR_channelsConfig[] = { 0x00000002u, 0x00000002u, 0x00000002u, 0x00000002u };
...
void ADC_SAR_Init(void)
{
    ...
    #if(ADC_SAR_CY_SAR_IP_VER == ADC_SAR_CY_SAR_IP_PSOC4)
        ADC_SAR_ANA_TRIM_REG = ADC_SAR_TRIM_COEF;
    #endif /* (ADC_SAR_CY_SAR_IP_VER == ADC_SAR_CY_SAR_IP_PSOC4) */
